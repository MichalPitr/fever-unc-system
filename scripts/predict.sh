...
mkdir -pv fever2/predictions/$MODEL/full/$1/$2-working


if [ "$(wc -l < fever2/$1/$2)" -eq "$(wc -l < fever2/predictions/$MODEL/oracle/$1/$2)" ];
then echo 'Skipping making predictions as this exists';
    ...
    python src/pipeline/fast_pipeline.py \
        ...
        --working-dir fever2/working_dir/$MODEL/full/$1/$2
fi;