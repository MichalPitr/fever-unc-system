...
class Model(nn.Module):
    def __init__(self, weight, vocab_size, embedding_dim,
        ...
        self.glove_embd_layer = Embedding(vocab_size, embedding_dim, weight=weight, padding_index=0)
...
def pipeline_function_list(item_list, model, vocab, cursor):
    ...
    complete_upstream_dev_data = disamb.sample_disamb_inference(item_list, cursor,
